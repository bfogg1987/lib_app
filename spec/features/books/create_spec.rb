...
describe "creating a new book" do 
	...
	# it "displays an error when the book has no month selected" do 
	# 	expect(Book.count).to eq(0)
	...
	# 	fill_in "Author", with: "Test Author"
	# 	select "2010", from: "book[publication_date(1i)]"
	# 	select "", from: "book[publication_date(2i)]"
	# 	select "15", from: "book[publication_date(3i)]"
	# 	fill_in "Serial number", with: "0123456789"
	# 	click_button "Create Book"
	...
	# it "displays an error when the book has no day selected" do 
	# 	expect(Book.count).to eq(0)
	...
	# 	select "2010", from: "book[publication_date(1i)]"
	# 	select "June", from: "book[publication_date(2i)]"
	# 	select "", from: "book[publication_date(3i)]"
	# 	fill_in "Serial number", with: "0123456789"
	# 	click_button "Create Book"
	...
	# it "displays an error when the book has no year selected" do 
	# 	expect(Book.count).to eq(0)
	...
	# 	fill_in "Title", with: "Test Title"
	# 	fill_in "Author", with: "Test Author"
	# 	select "", from: "book[publication_date(1i)]"
	# 	select "June", from: "book[publication_date(2i)]"
	# 	select "15", from: "book[publication_date(3i)]"
	# 	fill_in "Serial number", with: "0123456789"
	# 	click_button "Create Book"
	...
	# 	visit "/books"
	# 	expect(page).to_not_have_content "Book was successfully created"
	# end
